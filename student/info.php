			...
			<div class="container-fluid">
				<div class="card bg-dark text-center text-light">
				  <div class="card-body">
					...
					<p class="card-text">First Name : <b><?php echo $inf["firstname"];?></b></p>
					<p class="card-text">Last Name : <b><?php echo $inf["lastname"];?></b></p>
					<p class="card-text">Group : <b><?php echo $inf["grou"];?></b></p>
					<p class="card-text">Register Date : <b><?php echo $inf["regdate"];?></b></p>
				  </div>
				  <div class="card-body">
