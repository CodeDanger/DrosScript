...
$con=connect();
if(empty($_POST["firstname"])){header("Location: addstudent.php?warning=Please Enter First Name"); exit();}
if(empty($_POST["lastname"])){header("Location: addstudent.php?warning=Plaese Enter Last Name"); exit();}
$res=addStudent($con,$_POST["firstname"],$_POST["lastname"],$_POST["ispaid"],$_POST["group"],$_POST["sphone"],$_POST["pphone"]);
if($res==false){header("Location: addstudent.php?warning=Faild To Add Student"); exit();}
}else{
		...
		<div class="container-fluid justify-content-center text-center">
			...
			<div class="card card-cascade">
			  <div class="view view-cascade overlay">
				  <i class="card-img-top fas fa-user fa-fw fa-6x"></i>
				<a href="#!">
			  ...
			  <div class="card-body card-body-cascade text-center pb-0">
				...
				<h4 class="card-title"><strong>Student Information</strong></h4>
				<h5 class="blue-text pb-2"><strong>Username : <?php echo $res["Suser"];?></strong></h5>
				<h5 class="blue-text pb-2"><strong>Password : <?php echo $res["Spass"];?></strong></h5>
			...
			<div class="card card-cascade">
			  ...
			  <div class="card-body card-body-cascade text-center pb-0">
				...
				<h4 class="card-title"><strong>Parent Information</strong></h4>
				<h5 class="blue-text pb-2"><strong>Username : <?php echo $res["Puser"];?></strong></h5>
				<h5 class="blue-text pb-2"><strong>Password : <?php echo $res["Ppass"];?></strong></h5>
				<div class="card-footer text-muted text-center mt-4">
					Parent Information
				</div>
