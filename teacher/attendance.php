...
$tlist=getAttendanceAvilableDate($con);
?>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
	 ...
	 <div class="container-fluid justify-content-center text-center">
			<form method="POST" action="setAtten.php">
			...
			<h1> Export Date Attendance For Group</h1>
				<div class="form-group">
					<label for="gro">Group</label>
					<select class="form-control" name="group" id="gro">
					<?php
				 ...
				 <div class="form-group">
					<label for="gro">Date</label>
					<select class="form-control" name="date" id="gro">
					<?php
					for($k=0;$k<count($tlist);$k++){
					  echo '
					  <option value="'.$tlist[$k]["date"].'">'.$tlist[$k]["date"].'</option>
					  ';
					}
					 ?>
