  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
	 ...
	 <div class="container-fluid justify-content-center text-center">
			<form method="POST" action="nmsg.php">
			  	
				<div class="form-group">
					<label for="user">Parents</label>
					<select class="form-control" name="id" id="user">
					<?php
					for($k=0;$k<count($grlist);$k++){
					  echo '
					  <option value="'.$grlist[$k]["id"].'">'.$grlist[$k]["name"].'('.$grlist[$k]["username"].')</option>
					  ';
					}
					 ?>
					</select>
				...
				<div class="form-group">
					...
					<textarea class="form-control" style="height:300px;" type="text" name="content" id="content" ></textarea>
				 </div>
