  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
	 ...
	 <div class="container-fluid justify-content-center text-center">
			<form method="POST" action="setRes.php">
			  
				
				<div class="form-group">
					<label for="gro">Name</label>
					<select class="form-control" name="name" id="gro">
					<?php
					for($k=0;$k<count($oflist);$k++){
					  echo '
					  <option value="'.$oflist[$k]["id"].'">'.$oflist[$k]["name"].'</option>
					  ';
					}
					 ?>
