  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
	 ...
	 <div class="container-fluid justify-content-center text-center">
			<form method="POST" action="removeSt.php">
			  
			  	<div class="form-group">
					<label for="gro">Select Group</label>
					<select class="form-control" name="id" id="gro">
					<?php
					for($k=0;$k<count($grlist);$k++){
					  echo '
					  <option value="'.$grlist[$k]["id"].'">'.$grlist[$k]["firstname"].' '.$grlist[$k]["lastname"].'('.$grlist[$k]["username"].')</option>
					  ';
					}
					 ?>
