    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Set Group</li>
        </ol>
		<div class="container-fluid justify-content-center text-center">
			<form method="POST" action="setGr.php">
			  <div class="form-group">
				<label for="inp1">Student Username</label>
				<input type="text" class="form-control" id="inp1" name="user"  placeholder="Enter Username" required>
			  </div>
				<div class="form-group">
